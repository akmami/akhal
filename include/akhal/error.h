...
// Return codes
// 0 is success; all errors are negative so callers can test `if (rc < 0)`
// Keep these stable; append new codes at the end
enum {
    AK_OK      =  0,
    ...
    AK_EIO     = -6    // read/write failure on an open file
};
...
// Setting the threshold to AK_LOG_WARN suppresses INFO and DEBUG
// The CLI configures it once
enum {
    AK_LOG_ERROR = 0,
    AK_LOG_WARN  = 1,
    AK_LOG_INFO  = 2,
